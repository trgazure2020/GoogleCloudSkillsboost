#!/bin/bash
# congratulations on completing the lab!Gali gali me short hai tu script chor hai
...
echo "${CYAN}${BOLD}  Manage Cloud Storage Lifecycle Policy using gsutil
${RESET}"
echo "${CYAN}${BOLD}============================================${RESET}"
...
# Completion Message  Gali
echo "${MAGENTA}${BOLD}============================================${RESET}"
echo "${MAGENTA}${BOLD}   APP ENGINE DEPLOYMENT LAB COMPLETED!    ${RESET}"
echo "${MAGENTA}${BOLD}============================================${RESET}"
echo
echo "${GREEN}${BOLD}Congratulations on completing the lab!Gali gali me short hai tu script chor hai${RESET}"
echo
